...
bool R_PG_SCI_Set_C5(void)
{
	return R_SCI_Create(
		...
		BIT_31 | PDL_SCI_PCLK_DIV_1 | PDL_SCI_CYCLE_BIT_8 | 0x1e | (96774 & 0x00FFFF00ul),
		13
	);
}
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_StartSending_C5(uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_StartSending_C5
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_StartReceiving_C5(uint8_t * data, uint16_t count)
*
* Function Name: R_PG_SCI_StartReceiving_C5
*
...
* Include      : 
*
* Declaration  : bool R_PG_SCI_GetReceptionErrorFlag_C5(bool * parity, bool * framing, bool * overrun)
*
* Function Name: R_PG_SCI_GetReceptionErrorFlag_C5
*
