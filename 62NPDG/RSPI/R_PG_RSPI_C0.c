...
* Include      : 
*
* Declaration  : bool R_PG_RSPI_TransferAllData_C0(uint32_t * tx_start, uint32_t * rx_start, uint16_t sequence_loop_count)
*
* Function Name: R_PG_RSPI_TransferAllData_C0
*
