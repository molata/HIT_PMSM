...
bool R_PG_RSPI_Set_C1(void)
{
	return R_SPI_Create(
		1,
		PDL_SCI_MODE_SYNC_MASTER | PDL_SPI_FULL_DUPLEX | PDL_SPI_PIN_CMOS | PDL_SPI_PIN_A | PDL_SPI_PIN_RSPCK_ENABLE | PDL_SPI_PIN_MOSI_ENABLE | PDL_SPI_PIN_MISO_ENABLE | PDL_SPI_PIN_SSL0_DISABLE | PDL_SPI_PIN_SSL1_DISABLE | PDL_SPI_PIN_SSL2_DISABLE | PDL_SPI_PIN_SSL3_DISABLE | PDL_SPI_PIN_MOSI_IDLE_LAST,
...
bool R_PG_RSPI_SetCommand_C1(void)
{
	...
	res = R_SPI_Command(
		1,
		0,
		PDL_SPI_CLOCK_MODE_0 | PDL_SPI_DIV_1 | PDL_SPI_ASSERT_SSL0 | PDL_SPI_SSL_NEGATE | PDL_SPI_LENGTH_16 | PDL_SPI_MSB_FIRST,
